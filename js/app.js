...
createApp({
    setup() {
        ...
        const showClientModal = ref(false); // Modal de Cliente
        ...
        const newClient = reactive({ name: '', phone: '', cpf: '', email: '' }); // CAMPO EMAIL ADICIONADO
        ...
        return {
            ...
            showAppointmentModal, showClientModal, showServiceModal, // Exportando todos os controles de modal
            newService, saveService, deleteService,
            newClient, saveClient, // Exportando objeto e função de salvar cliente
