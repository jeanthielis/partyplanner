...
createApp({
    setup() {
        ...
        // Modais (Controles de visibilidade)
        ...
        // Formulários (Objetos temporários)
        ...
        // --- BUSCA CLIENTE (Correção de Loop) ---
        ...
        // --- FUNÇÃO QUE ESTAVA DANDO ERRO ---
        const startNewSchedule = () => { 
            isEditing.value=false; 
            Object.assign(tempApp, {
                clientId:'', date:'', time:'', location:{bairro:''}, 
                details:{entryFee:0, balloonColors:''}, notes: '', 
        ...
        const saveClient = async () => {
            ...
            showClientModal.value = false; // Fecha modal
            newClient.name = ''; newClient.phone = ''; newClient.cpf = ''; newClient.email = ''; // Limpa
        ...
        return {
            ...
            // EXPORTANDO AS FUNÇÕES QUE FALTAVAM
            startNewSchedule, 
            editAppointment, 
            saveAppointment, 
            ...
            deleteService,
            newClient, 
            saveClient, // IMPORTANTE: Exportando função de salvar cliente
            
            tempApp, tempServiceSelect, services, totalServices, finalBalance, isEditing, 
            clientSearchTerm, filteredClientsSearch, selectClient,
            ...
            catalogClientsList, catalogClientSearch, searchCatalogClients, 
            openClientModal: () => { showClientModal.value = true; }, // Link direto para abrir modal
            deleteClient,
